...
const Projects = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      link: "",
      github: "https://github.com/h3kar360/Claude-Code-Clone",
      status: true,
      status_desc: "online",
    },
    {
    ...
    },
    {
      ...
      link: "",
      github:
        "https://github.com/h3kar360/Fun-Fact-Video-Youtube-Shorts-Generator",
      status: true,
      status_desc: "online",
    },
    {
          ...
          <div className="border-t-2 lg:px-10 lg:py-8 flex items-center justify-between w-full">
            <div className="flex justify-evenly items-center lg:gap-10">
              <div className="relative group">
                <div className={statusStyle(project.status)}></div>
                <div
            ...
            <a href={project.link} target="_blank" className="lg:text-xl">
              {project.link}
            </a>
            <a href={project.github} target="_blank" className="shrink-0">
              <img src={Github} alt="Github" className="lg:w-8 lg:h-8" />
            </a>
          </div>
        ))}
      </section>
